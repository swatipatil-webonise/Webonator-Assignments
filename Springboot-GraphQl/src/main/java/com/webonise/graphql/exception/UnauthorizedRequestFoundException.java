...
public class UnauthorizedRequestFoundException extends RuntimeException implements GraphQLError {

	private static final long serialVersionUID = 1L;
	private final int errorCode;
	private final String errorMessage;
	
	public UnauthorizedRequestFoundException(int errorCode, String errorMessage) {
		super(errorMessage);
